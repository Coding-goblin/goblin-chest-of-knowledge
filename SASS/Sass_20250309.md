...
```
  * pokud budu dělat animace jako třeba reakci na uživatelovu akci jako `:hover`, tak čím pomalejší jsou, tím to uživatele víc sere a stránka působí pomale &#8594 doporučuje se 0.2s - 0.3s
